...
class AzureSpatialAnchorsManager {
    ...
    public static final String SpatialAnchorsAccountId = "00c5faad-51fb-4d2b-98de-988265346c67";

    // Set this string to the account key provided for the Azure Spatial Service resource.
    public static final String SpatialAnchorsAccountKey = "B15wUjZU8bH66aJIAEXVmLHgqYAn6xGvEAPjxYa4Xi0=";
